    ...
    <Page>
      <Fade>
        <form className={s.form} onSubmit={handleSubmit(onSubmitHandler)}>
          <div className={s.top}>
            <h1 className={s.top__tile}>Регистрация</h1>
            <Link href="/">
          ...
          <div className={s.form_btns}>
            <Link href={'/signin'}><a className={s.signup}>Войти в аккаунт</a></Link>
            <button type="submit" className={s.signin}>Зарегистрироваться</button>
          </div>
        </form>
      </Fade>
    </Page>
